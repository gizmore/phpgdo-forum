...
final class GDO_ForumPost extends GDO
{
	...
	{
		return $this->getThread()->canView($user) && $user !== $this->getCreator();
	}
	...
	public function gdoColumns(): array
	{
		return array(
			...
			GDT_Message::make('post_message')->utf8()
				->caseI()
				->notNull(),
	...
	{
		return $this->gdoVar('post_thread');
	}

	public function isFirstInThread()
	{
		return $this->gdoValue('post_first');
	}
	...
	{
		return $this->gdoVar('post_edited');
	}
	...
	{
		return $this->gdoValue('post_editor');
	}

	public function getEditorID()
	{
		return $this->gdoVar('post_editor');
	}
	...
	{
		return href('Forum', 'CRUDPost', '&id=' . $this->getID());
	}

	public function hrefReply()
	{
		return href('Forum', 'CRUDPost', '&reply=' . $this->getID());
	}

	public function hrefQuote()
	{
	...
	{
		return $this->signatureField()->renderHTML();
	}
