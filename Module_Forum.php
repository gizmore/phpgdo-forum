...
final class Module_Forum extends GDO_Module
{
    ...
    public function onLoadLanguage() : void { $this->loadLanguage('lang/forum'); }
    ...
    public function cfgHookLeftBar() { return $this->getConfigValue('hook_sidebar'); }
    ...
    public function renderTabs()
    {
        if (Application::$INSTANCE->isHTML())
        {
            GDT_Page::instance()->topResponse()->addField(
                GDT_Template::make()->template('Forum', 'tabs.php'));
        }
    }
